...
from utils.salsa_utils.libs.MotionScript.captioning_data import POSECODE_OPERATORS_VALUES, MOTIONCODE_OPERATORS_VALUES, TIMECODE_OPERTATOR_VALUES # ADD_POSECODE_KIND
...
class MotioncodeGeneral(Motioncode):
    ...
    def eval(self, pm_joint_id_pairs, joint_coords, p_interpretations):
        ...
        for pair in pm_joint_id_pairs: # question: joint_ids --> p_interpretation ==>
            # we should double check between motions and pose codes joint sets
