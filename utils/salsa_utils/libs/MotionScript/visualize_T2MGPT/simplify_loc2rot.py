...
import smplx
import h5py
from utils.salsa_utils.libs.MotionScript.visualize_T2MGPT.joints2smpl.src.smplify import SMPLify3D
from tqdm import tqdm
import utils.salsa_utils.libs.MotionScript.visualize_T2MGPT.rotation_conversions as geometry
import argparse
...
class joints2smpl:
    ...
    def joint2smpl(self, input_joints, init_params=None):
        ...
        new_opt_cam_t, new_opt_joint_loss, smpl_output = _smplify(
            pred_pose.detach(),
            pred_betas.detach(),
            pred_cam_t.detach(),
            keypoints_3d,
